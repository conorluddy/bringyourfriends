...
# SQLite
DataMapper.setup(:default, ENV['DATABASE_URL'] || "sqlite3://#{Dir.pwd}/developmentv0.2.2.db")
...
class Trip
	...
	property 	:startLat, 		String,	:length => 20
	property 	:startLon, 		String,	:length => 20
	property 	:endLat, 		String,	:length => 20
	property 	:endLon, 		String,	:length => 20
	property 	:polyline, 		String,	:length => 2048 # This can cause URL's to be too long to work
...
class Invitation
	...
	property :reply,		String,	:length => 255
